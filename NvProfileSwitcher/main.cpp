...
enum {ID_TRAY_OPEN=2001,ID_TRAY_ABOUT,ID_TRAY_EXIT};
...
void Paint(HWND w){
    ...
    DrawTextW(dc,versionBadge.c_str(),-1,&verText,DT_CENTER|DT_VCENTER|DT_SINGLELINE);
