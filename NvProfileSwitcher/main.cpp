...
void SetDesktopUi(bool desktop){
    ...
    MoveWindow(H(IDC_STARTWIN),rightX,r.bottom-56,20,22,TRUE);
    MoveWindow(GetWindow(H(IDC_STARTWIN),GW_HWNDNEXT),rightX+24,r.bottom-55,135,22,TRUE);
    MoveWindow(H(IDC_STARTMIN),rightX+220,r.bottom-56,20,22,TRUE);
    MoveWindow(GetWindow(H(IDC_STARTMIN),GW_HWNDNEXT),rightX+244,r.bottom-55,175,22,TRUE);

    MoveWindow(H(IDC_MINTRAY),rightX,r.bottom-40,20,22,TRUE);
    MoveWindow(GetWindow(H(IDC_MINTRAY),GW_HWNDNEXT),rightX+24,r.bottom-39,135,22,TRUE);
    MoveWindow(H(IDC_CHECKUPDATES),rightX+220,r.bottom-40,20,22,TRUE);
    MoveWindow(GetWindow(H(IDC_CHECKUPDATES),GW_HWNDNEXT),rightX+244,r.bottom-39,145,22,TRUE);
...
void BuildControls(){
    ...
    Add(L"BUTTON",L"",BS_AUTOCHECKBOX,rightX,r.bottom-56,20,22,IDC_STARTWIN);
    Add(L"STATIC",L"Start with Windows",0,rightX+24,r.bottom-55,135,22,0);
    Add(L"BUTTON",L"",BS_AUTOCHECKBOX,rightX+220,r.bottom-56,20,22,IDC_STARTMIN);
    Add(L"STATIC",L"Start minimized to tray",0,rightX+244,r.bottom-55,175,22,0);

    Add(L"BUTTON",L"",BS_AUTOCHECKBOX,rightX,r.bottom-40,20,22,IDC_MINTRAY);
    Add(L"STATIC",L"Minimize to tray",0,rightX+24,r.bottom-39,135,22,0);
    Add(L"BUTTON",L"",BS_AUTOCHECKBOX,rightX+220,r.bottom-40,20,22,IDC_CHECKUPDATES);
    Add(L"STATIC",L"Check for updates",0,rightX+244,r.bottom-39,145,22,0);
