...
void SetDesktopUi(bool desktop){
    ...
    for(auto sp:std::vector<SPos>{
        ...
        MoveWindow(H(sp.lbl),rightX+29,sp.y-2,161,22,TRUE);
    ...
    MoveWindow(H(IDC_CHECKUPDATES),rightX+220,r.bottom-51,20,22,TRUE);
    MoveWindow(GetWindow(H(IDC_CHECKUPDATES),GW_HWNDNEXT),rightX+244,r.bottom-50,145,22,TRUE);
...
static const BYTE kNvidiaDriverPng[] = {
    ...
    ,
};

void DrawDriverIcon(HDC dc,int x,int y,COLORREF){
    // Real NVIDIA PNG supplied for the footer. Drawn at 16x16.
    HGLOBAL mem=GlobalAlloc(GMEM_MOVEABLE,sizeof(kNvidiaDriverPng));
    if(!mem) return;
    void* dst=GlobalLock(mem);
    if(!dst){ GlobalFree(mem); return; }
    memcpy(dst,kNvidiaDriverPng,sizeof(kNvidiaDriverPng));
    GlobalUnlock(mem);
    ...
    if(image.GetLastStatus()==Gdiplus::Ok){
        ...
        g.DrawImage(&image,Gdiplus::Rect(x,y,16,16));
    }
    stream->Release();
}
...
void Paint(HWND w){
    ...
    // Divider and driver info with the NVIDIA logo.
...
void ResizeControls(){
    ...
    MoveWindow(H(IDC_ADD),34,r.bottom-169,110,32,TRUE);
    MoveWindow(H(IDC_REMOVE),154,r.bottom-169,110,32,TRUE);
