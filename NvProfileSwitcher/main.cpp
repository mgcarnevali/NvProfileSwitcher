...
void BuildControls(){
    ...
    Add(L"BUTTON",L"Add profile",BS_OWNERDRAW,40,r.bottom-169,122,32,IDC_ADD);
    Add(L"BUTTON",L"Remove",BS_OWNERDRAW,172,r.bottom-169,110,32,IDC_REMOVE);
...
void ResizeControls(){
    ...
    MoveWindow(H(IDC_ADD),40,r.bottom-169,122,32,TRUE);
    MoveWindow(H(IDC_REMOVE),172,r.bottom-169,110,32,TRUE);
