...
void DrawOwnerButton(const DRAWITEMSTRUCT* d){
    ...
    if(id==IDC_REMOVE) start-=3; // optical centering for the trash icon + label
...
void BuildControls(){
    ...
    Add(L"BUTTON",L"Add profile",BS_OWNERDRAW,34,r.bottom-169,122,32,IDC_ADD);
    Add(L"BUTTON",L"Remove",BS_OWNERDRAW,166,r.bottom-169,110,32,IDC_REMOVE);
...
void ResizeControls(){
    ...
    MoveWindow(H(IDC_ADD),34,r.bottom-169,122,32,TRUE);
    MoveWindow(H(IDC_REMOVE),166,r.bottom-169,110,32,TRUE);
